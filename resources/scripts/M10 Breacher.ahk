...
ApplyOverrides() {
    global TargetWindowTitle, MarkerFilePath, HoldLMBTime, PreTomahawkWait, ResetTime, VWaitTime, ScoreboardToggling, Movement, HoldWTime, BackgroundInput, MouseBlocker, AutoStart, ToggleKey, ExitKey, LethalKey, WeaponSwitchKey, ScoreboardKey, MeleeKey
