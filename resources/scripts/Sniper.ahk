...
ApplyOverrides() {
    global TargetWindowTitle, MarkerFilePath, ResetTime, VWaitTime, ScoreboardToggling, BackgroundInput, MouseBlocker, AutoStart, ToggleKey, ExitKey, LethalKey, WeaponSwitchKey, ScoreboardKey, MeleeKey
