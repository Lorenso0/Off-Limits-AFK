...
ApplyOverrides() {
    global TargetWindowTitle, MarkerFilePath, VDelay, VDelayRnd, ScoreboardToggling, Movement, HoldWTime, BackgroundInput, MouseBlocker, AutoStart, ToggleKey, ExitKey, ScoreboardKey, MeleeKey
