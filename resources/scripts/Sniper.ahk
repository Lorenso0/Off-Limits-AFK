...
ApplyOverrides() {
    global TargetWindowTitle, MarkerFilePath, ResetTime, VWaitTime, ScoreboardToggling, Movement, HoldWTime, BackgroundInput, MouseBlocker, AutoStart, ToggleKey, ExitKey, LethalKey, WeaponSwitchKey, ScoreboardKey, MeleeKey
