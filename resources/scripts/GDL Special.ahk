...
ApplyOverrides() {
    global TargetWindowTitle, MarkerFilePath, HoldLMBTime, PostLMBWait, PostRMBWait, PreMeleeWait, VWaitTime, ScoreboardToggling, BackgroundInput, MouseBlocker, AutoStart, ToggleKey, ExitKey, ScoreboardKey, MeleeKey
