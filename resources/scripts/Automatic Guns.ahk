...
ApplyOverrides() {
    global TargetWindowTitle, MarkerFilePath, HoldLMBTime, PreMeleeWait, VWaitTime, ScoreboardToggling, ToggleKey, ExitKey, ScoreboardKey, MeleeKey
